        ...
        {items.map((item, idx) => {
          ...
          return (
            ...
            >
              ...
              <ReusableCard className={cardClassName}>
                ...
                <ReusableCardDescription>{item.description}</ReusableCardDescription>
              </ReusableCard>
            </Component>
          );
        })}
...
export const ReusableCardTitle = ({
  className,
  children,
}: {
  className?: string;
...
export const ReusableCardDescription = ({
  className,
  children,
}: {
  className?: string;
